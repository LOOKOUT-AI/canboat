...
## [8.0.0](https://github.com/LOOKOUT-AI/canboat/compare/v7.1.0...v8.0.0) (2026-07-22)
...
* **126720:** restore shadowed variants and dedupe Maretron/BEP PGNs ([#744](https://github.com/LOOKOUT-AI/canboat/issues/744)) ([7796fba](https://github.com/LOOKOUT-AI/canboat/commit/7796fba0e861fc80f6cbe795c94d5b01326892ee))
* **130827:** decode Furuno NavPilot status ([#742](https://github.com/LOOKOUT-AI/canboat/issues/742)) ([58a0f26](https://github.com/LOOKOUT-AI/canboat/commit/58a0f26e4d53d5c58d0819ba0a030e035d042539))
* **540:** expose Unknown/OutOfRange/Reserved special values per field ([#672](https://github.com/LOOKOUT-AI/canboat/issues/672)) ([20e98c7](https://github.com/LOOKOUT-AI/canboat/commit/20e98c75673ac6eda0676a0fde0b33cc0ea8968a))
* **540:** per-field-type .sentinels + lookup top-of-range markers ([#704](https://github.com/LOOKOUT-AI/canboat/issues/704)) ([ce03421](https://github.com/LOOKOUT-AI/canboat/commit/ce03421e1d257569808a55404cbc7e672cf74716))
* **65301,130819:** decode BEP CZone proprietary PGN fields ([444dd4f](https://github.com/LOOKOUT-AI/canboat/commit/444dd4f89c5578eca68c125ccf6f8582b31a26c3))
* **65301,130819:** decode BEP Marine CZone PGN fields ([cc39e13](https://github.com/LOOKOUT-AI/canboat/commit/cc39e139d249ea883ccba4d843abe426583f3414))
* **654:** reconcile PGN database against NMEA 2000 PDF v1.3 ([#671](https://github.com/LOOKOUT-AI/canboat/issues/671)) ([813bef8](https://github.com/LOOKOUT-AI/canboat/commit/813bef8d27f54e7edda7628d476568542dc4f672))
* **693:** "NMEA 2000 gateway: network status" PGN — rename + socketcan/actisense emission ([#698](https://github.com/LOOKOUT-AI/canboat/issues/698)) ([a6f6c78](https://github.com/LOOKOUT-AI/canboat/commit/a6f6c780730cec3154c7ce77d244d4bd9fcbfa84))
* add 19 Maretron product codes from MConnect ([f1344e3](https://github.com/LOOKOUT-AI/canboat/commit/f1344e396ff969b469e7ad1cfc8dbd0400eb1ddc))
* add 8 missing PGNs from the NMEA 3.002 field-name list ([#655](https://github.com/LOOKOUT-AI/canboat/issues/655)) ([#673](https://github.com/LOOKOUT-AI/canboat/issues/673)) ([3efabb1](https://github.com/LOOKOUT-AI/canboat/commit/3efabb13075d16c2a1e0f998415f17b4a5a4220f))
* add BEP Marine / CZone proprietary PGN stubs ([2973d72](https://github.com/LOOKOUT-AI/canboat/commit/2973d72c6ff674bb0c6cdd53ea0f58845554efc9))
* add BEP Marine / CZone proprietary PGN stubs ([32d44ed](https://github.com/LOOKOUT-AI/canboat/commit/32d44ed731b025e18a8055d26892040a615c5217))
* add BEP Marine fast-packet stubs and Lumishore proprietary PGN ([83c4326](https://github.com/LOOKOUT-AI/canboat/commit/83c43269cf78fd36c6e848afccad430e540bc60f))
* add BEP Marine fast-packet stubs and Lumishore proprietary PGN ([e3b7dbe](https://github.com/LOOKOUT-AI/canboat/commit/e3b7dbea11595042977ca7d9d7d9fe0c9ffab066))
* add Carling switchboard PGNs 65300/130921 and fill in Maretron Windlass 130843 ([0a9a72e](https://github.com/LOOKOUT-AI/canboat/commit/0a9a72e3df30e4281ae19a2246fe08a7ee701162))
* add Carling switchboard PGNs and fill in Maretron Windlass ([a06a1ee](https://github.com/LOOKOUT-AI/canboat/commit/a06a1eefc3311617ce07e0c7ca59eaa54f110fff))
* add HVAC Status PGN and fill in Maretron infrastructure stubs ([5103b84](https://github.com/LOOKOUT-AI/canboat/commit/5103b844bf884bb40c531f25a5f2d6e285d17a79))
* add HVAC Status PGN and fill in Maretron infrastructure stubs ([7d77748](https://github.com/LOOKOUT-AI/canboat/commit/7d77748106c86ad131725be84a4f568f327ef6c0))
* add J1939 Electronic Transmission Controller 1 (PGN 61142) ([5fe672f](https://github.com/LOOKOUT-AI/canboat/commit/5fe672f3424097e0c774478c950546c58a45f243))
* add J1939 Electronic Transmission Controller 1 (PGN 61142) ([b382493](https://github.com/LOOKOUT-AI/canboat/commit/b382493e18984d59d1cf421192a0bac309a64765))
* add Maretron Alert Transmission PGN 130819 identity header ([f3663f2](https://github.com/LOOKOUT-AI/canboat/commit/f3663f25d3450976ba7d64cf985a80c9f695a529))
* add maretron-ipg, a TCP client for the Maretron IPG100 gateway ([3ee1433](https://github.com/LOOKOUT-AI/canboat/commit/3ee14334568404c7511010b516465f0a6a15664b))
* add maretron-ipg, a TCP client for the Maretron IPG100 gateway ([47f6d1c](https://github.com/LOOKOUT-AI/canboat/commit/47f6d1c8bb664e1ef6d9b216fe65f2f73542ab0e))
* add Mercury, Yamaha, Navico, B&G and Simrad proprietary PGN stubs ([4fcbbdf](https://github.com/LOOKOUT-AI/canboat/commit/4fcbbdf6f38b9817a9c1d74db4887ac812d692f0))
* add Navico Naviop and BEP CZone switching PGN stubs ([56acf73](https://github.com/LOOKOUT-AI/canboat/commit/56acf73202891851a6963a656ce7bacd1a4e8b6a))
* add Navico Naviop and BEP CZone switching PGN stubs ([55ccb18](https://github.com/LOOKOUT-AI/canboat/commit/55ccb188614eba7eca8e6e6d06c88bb9ac3bffdb))
* add proprietary PGN stubs and resolve PACKET_RESOLUTION_UNKNOWN ([8820443](https://github.com/LOOKOUT-AI/canboat/commit/8820443a43a2926636c09fed204c3ceb71fd3915))
* add Sea Recovery Watermaker and Webasto Status 2 PGN definitions ([e1d47f0](https://github.com/LOOKOUT-AI/canboat/commit/e1d47f0e5de8ad2d58da4915d2e46f1c5171ae89))
* add Suzuki, Yanmar and Honda proprietary PGN stubs ([614d1d6](https://github.com/LOOKOUT-AI/canboat/commit/614d1d686ebde2b09261892d67248dd673ccc8e8))
* add Suzuki, Yanmar and Honda proprietary PGN stubs ([3995b5c](https://github.com/LOOKOUT-AI/canboat/commit/3995b5c05219e3a7f49e651c86b6b46f8f4c9b0a))
* add Webasto HVAC Command and Carling DC Configuration Command PGNs ([b5a88ed](https://github.com/LOOKOUT-AI/canboat/commit/b5a88ed2a45f8f693d8d4249efd2de01f4a2280f))
* add Webasto HVAC Command and Carling DC Configuration Command PGNs ([a86fc8c](https://github.com/LOOKOUT-AI/canboat/commit/a86fc8c950954c9082300038cbfbd9224505ab99))
* add Xantrex and Lumishore proprietary PGN definitions ([3db5e4e](https://github.com/LOOKOUT-AI/canboat/commit/3db5e4ef9f24eee23a259bffd5d7f07733ee1dc8))
* **dbc:** multiplex proprietary PGN variants; move to docs/canboat.dbc ([#707](https://github.com/LOOKOUT-AI/canboat/issues/707)) ([859bf85](https://github.com/LOOKOUT-AI/canboat/commit/859bf859af76c6627b4cd357718dd830f2ac7d38))
* decode Discrete Status 1 bitfield in PGN 127493 ([#419](https://github.com/LOOKOUT-AI/canboat/issues/419)) ([#667](https://github.com/LOOKOUT-AI/canboat/issues/667)) ([bd2fb6b](https://github.com/LOOKOUT-AI/canboat/commit/bd2fb6b92cffba3497cd4c58b1ec77cdecdd7e18))
* decode Garmin autopilot scalar transport over PGN 126720 ([#688](https://github.com/LOOKOUT-AI/canboat/issues/688)) ([#692](https://github.com/LOOKOUT-AI/canboat/issues/692)) ([3f6ce56](https://github.com/LOOKOUT-AI/canboat/commit/3f6ce561f933c3e14769c4c6aa605c341d9f361b))
* fill in Maretron Alert family PGNs 130820/130821/130822 identity headers ([cf3ccf9](https://github.com/LOOKOUT-AI/canboat/commit/cf3ccf939f662c3ba4ec7b5f3d7713a19c8a0228))
* fill in Maretron Alert family PGNs 130820/130821/130822 identity headers ([f504ad8](https://github.com/LOOKOUT-AI/canboat/commit/f504ad8db7ee71de1df7803c24203b4bd479cea3))
* fill in Maretron proprietary PGN field layouts + add Carling Breaker Command ([943407f](https://github.com/LOOKOUT-AI/canboat/commit/943407f254b677ceae8bdd50843f9a446c640dca))
* fold canboat-py extended-decoder notes into Mercury PGN descriptions ([#689](https://github.com/LOOKOUT-AI/canboat/issues/689)) ([#690](https://github.com/LOOKOUT-AI/canboat/issues/690)) ([27ca9b5](https://github.com/LOOKOUT-AI/canboat/commit/27ca9b5f9fe129077949c4a3acd7ff29555e4e39))
* **furuno:** correct PGN 130845 satellite record layout and decode Baseline status ([#723](https://github.com/LOOKOUT-AI/canboat/issues/723)) ([e72b6d5](https://github.com/LOOKOUT-AI/canboat/commit/e72b6d5c4790ff1b77f67913d299d76547be1fb7))
* **fusion:** decode additional 130820 status messages ([#682](https://github.com/LOOKOUT-AI/canboat/issues/682)) ([906dcde](https://github.com/LOOKOUT-AI/canboat/commit/906dcdebc653f9cc6fac0c50e4069acc1711ca44)), closes [#678](https://github.com/LOOKOUT-AI/canboat/issues/678)
* **mercury:** decode VesselView-Link PGNs 130824/130825/130826/130829 ([#683](https://github.com/LOOKOUT-AI/canboat/issues/683)) ([9f380a8](https://github.com/LOOKOUT-AI/canboat/commit/9f380a8ac5694702fc4d818264a0fabae1fe785e))
* **navico:** add 130824 B&G start-line & MOB position keys ([#708](https://github.com/LOOKOUT-AI/canboat/issues/708)) ([2938fd8](https://github.com/LOOKOUT-AI/canboat/commit/2938fd80be71d3c2117c35f823007ed069c67d08))
* **navico:** add compass auto-calibration mode key; fix Local field units (130845) ([#720](https://github.com/LOOKOUT-AI/canboat/issues/720)) ([e59571c](https://github.com/LOOKOUT-AI/canboat/commit/e59571c5a47d3ce3eead7f2c7473913f9782a675)), closes [#718](https://github.com/LOOKOUT-AI/canboat/issues/718)
* **navico:** correct PGN 65350 layout to normalized magnetic field vector X/Y/Z ([#719](https://github.com/LOOKOUT-AI/canboat/issues/719)) ([4426234](https://github.com/LOOKOUT-AI/canboat/commit/44262343b2bec327b8ad26c3eacbdaa70e149486)), closes [#716](https://github.com/LOOKOUT-AI/canboat/issues/716)
* **navico:** decode 65313 Depth Quality and 130825 NDP2k Alert ([#686](https://github.com/LOOKOUT-AI/canboat/issues/686)) ([8df21c8](https://github.com/LOOKOUT-AI/canboat/commit/8df21c8466d9112f24828a119ec1b7717bd80358))
* **navico:** decode five proprietary Navico/Simrad/Lowrance PGNs ([#743](https://github.com/LOOKOUT-AI/canboat/issues/743)) ([6f47c34](https://github.com/LOOKOUT-AI/canboat/commit/6f47c343b67db04c53b34b1126a3a1d04eca0768))
* **navico:** decode PGN 130822 Command 3 "Bulk Report 3" Section 10 settings ([#733](https://github.com/LOOKOUT-AI/canboat/issues/733)) ([ac21513](https://github.com/LOOKOUT-AI/canboat/commit/ac21513352688a90d253a3f185347b2ca086ef24))
* **navico:** decode PGN 130823 directory records, 130817 feature-unlock, and harden group-function/key-value handling ([#741](https://github.com/LOOKOUT-AI/canboat/issues/741)) ([c41bdd5](https://github.com/LOOKOUT-AI/canboat/commit/c41bdd5c90c454072b695014a5c9ace90ded226e))
* **navico:** decode PGN 130845 display unit-preference keys ([#729](https://github.com/LOOKOUT-AI/canboat/issues/729)) ([dab64cd](https://github.com/LOOKOUT-AI/canboat/commit/dab64cd0b409aa3e4c2e11ce92a3e91b00e043f1))
* **navico:** decode PGN 130845 instrument damping settings ([#730](https://github.com/LOOKOUT-AI/canboat/issues/730)) ([#731](https://github.com/LOOKOUT-AI/canboat/issues/731)) ([244abdf](https://github.com/LOOKOUT-AI/canboat/commit/244abdfdcbe9aa7b8c432448f6dfd47742c4d552))
* **navico:** decode proprietary PGNs 65303/65304, 130823, 130852 ([#728](https://github.com/LOOKOUT-AI/canboat/issues/728)) ([5003dff](https://github.com/LOOKOUT-AI/canboat/commit/5003dff6c0d2358c14d0ae8d7c9f24a6bbfe90df))
* **navico:** decode SIMNET_ALARM_COMMAND 88 as Tack/Gybe Confirm ([#739](https://github.com/LOOKOUT-AI/canboat/issues/739)) ([98b5240](https://github.com/LOOKOUT-AI/canboat/commit/98b52409c879779c47c2826424dec13310591397))
* **navico:** drop PGN 130861 "Simrad: Engine Data" — no producer exists ([#721](https://github.com/LOOKOUT-AI/canboat/issues/721)) ([28d39e7](https://github.com/LOOKOUT-AI/canboat/commit/28d39e740e46c7aab40738e1cff85664e7046c55)), closes [#712](https://github.com/LOOKOUT-AI/canboat/issues/712)
* **navico:** resolve PGN 65323 & 130840 Simnet Data Source Selection ([#725](https://github.com/LOOKOUT-AI/canboat/issues/725)) ([20fee4f](https://github.com/LOOKOUT-AI/canboat/commit/20fee4f49fc16305e1450a10808a865e11a062dc))
* **navico:** rework Simnet 130845/130846 Key/Parameter PGNs from firmware ([#701](https://github.com/LOOKOUT-AI/canboat/issues/701)) ([9fe36ac](https://github.com/LOOKOUT-AI/canboat/commit/9fe36ac99ad6f562c286798daac4f661757647a8))
* **navico:** unify SIMNET_DISPLAY_GROUP into SIMNET_NETWORK_GROUP ([#732](https://github.com/LOOKOUT-AI/canboat/issues/732)) ([1e6a7e6](https://github.com/LOOKOUT-AI/canboat/commit/1e6a7e679e12b29f04861ee609f2e319f91f0dcd))
* **pk:** mark Function Code (126464) and Report (65305) as PartOfPrimaryKey ([#713](https://github.com/LOOKOUT-AI/canboat/issues/713)) ([e0348ad](https://github.com/LOOKOUT-AI/canboat/commit/e0348ade718c030c3312e6bd8542f221e76222a3))
* read Actisense W2K-1 files in actisense-serial ([#662](https://github.com/LOOKOUT-AI/canboat/issues/662)) ([c460636](https://github.com/LOOKOUT-AI/canboat/commit/c460636c218cc98c4c72f12c36bedc30865f6142))
* read PCAN-View trace files in candump2analyzer ([#250](https://github.com/LOOKOUT-AI/canboat/issues/250)) ([#665](https://github.com/LOOKOUT-AI/canboat/issues/665)) ([1123b97](https://github.com/LOOKOUT-AI/canboat/commit/1123b975f5e97f8932e9ed673f56e9183b1f9b78))
* reassemble ISO 11783-3 Transport Protocol (PGN 60416/60160) messages ([#736](https://github.com/LOOKOUT-AI/canboat/issues/736)) ([339669b](https://github.com/LOOKOUT-AI/canboat/commit/339669b8e6862a859a5747a947d067215cdc372c))
* **seatalk:** add alarm IDs 112/113/122-125 and Bluetooth alarm group ([#709](https://github.com/LOOKOUT-AI/canboat/issues/709)) ([893287b](https://github.com/LOOKOUT-AI/canboat/commit/893287b2e93c14e6e318073a4878db5d436d9dc1)), closes [#552](https://github.com/LOOKOUT-AI/canboat/issues/552)
* **victron:** decode VE.Can VREG registers via a key/value/type table (61184) ([#681](https://github.com/LOOKOUT-AI/canboat/issues/681)) ([99c4c0a](https://github.com/LOOKOUT-AI/canboat/commit/99c4c0ab6fae970b79fe3884019050b526a2666d)), closes [#677](https://github.com/LOOKOUT-AI/canboat/issues/677)


### Fixed

* **126993:** heartbeat "Data transmit offset" is in milliseconds ([#696](https://github.com/LOOKOUT-AI/canboat/issues/696)) ([d6afb2a](https://github.com/LOOKOUT-AI/canboat/commit/d6afb2ab457a1e23d1a16f64a2001ac08939b3fa))
* **130820:** BEP CZone alarm string response ([62aed9a](https://github.com/LOOKOUT-AI/canboat/commit/62aed9a126db735528eac20f8a44f461bbdb7587))
* **130820:** BEP CZone alarm string response (builds on [#636](https://github.com/LOOKOUT-AI/canboat/issues/636)) ([82d2ecd](https://github.com/LOOKOUT-AI/canboat/commit/82d2ecd27f72237f0c5b6edcfaaa17a6c8faf59f))
* **130830:** correct field sizes for Maretron Dometic HVAC Status ([8b92002](https://github.com/LOOKOUT-AI/canboat/commit/8b9200234cfdd51a0c024acdc9358ee4cc330d27))
* **130830:** correct field sizes for Maretron Dometic HVAC Status ([0099608](https://github.com/LOOKOUT-AI/canboat/commit/009960866c2c14be494be92bbb79ad66abefbc2b))
* 356: Add GNSS type to PGN 129810 ([4e941c4](https://github.com/LOOKOUT-AI/canboat/commit/4e941c40add2a453da3a0cecccce50bb2af4868e))
* 423: Generated files ([afc4742](https://github.com/LOOKOUT-AI/canboat/commit/afc47428803a14439910b5abc0ee8ecef119f737))
* 428 ([f61941d](https://github.com/LOOKOUT-AI/canboat/commit/f61941dc9d190d020863cdeb283466c07437f1b7))
* 439 ([3470b08](https://github.com/LOOKOUT-AI/canboat/commit/3470b0860cfc58adb71cdcae960157de7eb7c37f))
* 442 ([34a5e3f](https://github.com/LOOKOUT-AI/canboat/commit/34a5e3fff8f02f42ff1563961cf7c4493aeef7e6))
* 442 ([3434201](https://github.com/LOOKOUT-AI/canboat/commit/3434201e046e94b528ff22d5262a18062bd84611))
* 444 ([ad8f22e](https://github.com/LOOKOUT-AI/canboat/commit/ad8f22e75204d79f0c14411e27fa730811f11539))
* 448 ([bbd30ab](https://github.com/LOOKOUT-AI/canboat/commit/bbd30ab5f1a6569406a52a082dccee613a715a71))
* 450: Maretron 130836 Switch Counter Status field lengths incorrect ([bd8dc0a](https://github.com/LOOKOUT-AI/canboat/commit/bd8dc0a58edea1f01c9c00dc7b91bae06f77ffe4))
* 451 ([f121e9b](https://github.com/LOOKOUT-AI/canboat/commit/f121e9b6da099526dcca86a58c6b8703a188671d))
* 452: Add define to compile replay binary on strict linux systems ([2a7dc4d](https://github.com/LOOKOUT-AI/canboat/commit/2a7dc4d7137ff9b3004c799b8d58273bcca93eba))
* 454: PGN 129538 fields ([35fcf41](https://github.com/LOOKOUT-AI/canboat/commit/35fcf417d6e281a843efe35ce1f8fc21ea712cd3))
* 461: fix 128520 and 130821 max string length ([6b6c4ea](https://github.com/LOOKOUT-AI/canboat/commit/6b6c4ea014625a3f18ebddadbfac50736f61125f))
* 463: Fast packet with size 223 (32 frames) doesn't assemble properly on 32 bit platform ([0426916](https://github.com/LOOKOUT-AI/canboat/commit/042691660e1c6aad13f4e2d3fe6c81c74dc701ca))
* 464: PGN 127508 Voltage should be signed ([0337ce5](https://github.com/LOOKOUT-AI/canboat/commit/0337ce5c05d04009ddc28a8f6326257a6fa5d2af))
* 465: Document obsoleteness of pgns.xml and pgns.json ([cd059e3](https://github.com/LOOKOUT-AI/canboat/commit/cd059e3dc04724bf986edf5f9f347889828394b1))
* 466: RangeMax is incorrect for DECIMAL fields ([1157bc9](https://github.com/LOOKOUT-AI/canboat/commit/1157bc9e030ad9645a27829fd9e2d1b832a0044c))
* 467: dbc-exporter build fails on newer python installations ([8caa06b](https://github.com/LOOKOUT-AI/canboat/commit/8caa06bb1d62e8310f1d9249dc69e716e69dfd26))
* 468: Remove Unicode characters in canboat.json and canboat.xml ([d931d11](https://github.com/LOOKOUT-AI/canboat/commit/d931d1157ebc31860058db655dbf47f6c3e067a9))
* 469: Fix compiler warnings ([2582b2f](https://github.com/LOOKOUT-AI/canboat/commit/2582b2f9f331c05c4edd27536fef90d7189cd6ac))
* 472 ([181faef](https://github.com/LOOKOUT-AI/canboat/commit/181faef7f0bfbd094147c9fd7e3fd0896ba710c0))
* 473 ([1422766](https://github.com/LOOKOUT-AI/canboat/commit/14227665ddaa12c5911815ae1847eb3ec379908a))
* 474 ([eca8ee0](https://github.com/LOOKOUT-AI/canboat/commit/eca8ee04878b1b0e98332d4debaaa31ff036c2dc))
* 478 ([59e42b7](https://github.com/LOOKOUT-AI/canboat/commit/59e42b79cf55336f539ac50411addf68ad519c1b))
* 481: Add revatek ([6f73807](https://github.com/LOOKOUT-AI/canboat/commit/6f73807ccbc4b7ffeb3a08e919b994792ae28e3e))
* 482 ([9d3fa95](https://github.com/LOOKOUT-AI/canboat/commit/9d3fa951a1a605c5d0776e4babc7b76c5d5c7576))
* 483 ([2ce58ac](https://github.com/LOOKOUT-AI/canboat/commit/2ce58ac56ef00ac65424a52cb4a847d1829aa26c))
* 488 ([c6acdb2](https://github.com/LOOKOUT-AI/canboat/commit/c6acdb2e8f1e9798d0bd69f682519dbcaf7d814c))
* 489 ([ff6f730](https://github.com/LOOKOUT-AI/canboat/commit/ff6f7309ce6ea8f6d6664de0ca065a6a75641cdf))
* 497 ([dade764](https://github.com/LOOKOUT-AI/canboat/commit/dade764a61dcc9c971107952065a2fd55e3f44ca))
* 498 ([4821fef](https://github.com/LOOKOUT-AI/canboat/commit/4821fefe98f666ecaca5a14da0b8fbc292edd4e4))
* 499 ([8c8a31a](https://github.com/LOOKOUT-AI/canboat/commit/8c8a31a17b272dc6a5b40db2bc702f23273b6c1a))
* 500 ([9aebce6](https://github.com/LOOKOUT-AI/canboat/commit/9aebce61f1d761a5e2ba4a3221dfcb399b93cdee))
* 506 ([4d66fc7](https://github.com/LOOKOUT-AI/canboat/commit/4d66fc7ca00497f1f7d3849a2a966b2b4f2005f0))
* 506 ([b1642b1](https://github.com/LOOKOUT-AI/canboat/commit/b1642b10256fc90ae7fa746762bb7513b16980e3))
* 514 ([bc1d71c](https://github.com/LOOKOUT-AI/canboat/commit/bc1d71c3f9a08aa01bcb2a3a1a10619c627fc882))
* 517: PGN 130323 field Mode should be lookup RESIDUAL_MODE. ([7b0bf7b](https://github.com/LOOKOUT-AI/canboat/commit/7b0bf7b6aec1590c3b6d776add0f0bd6cbb1ae71))
* 521 ([77d3af6](https://github.com/LOOKOUT-AI/canboat/commit/77d3af6c2120bafd3506469f135fc54b16b7f884))
* 522 ([59581f2](https://github.com/LOOKOUT-AI/canboat/commit/59581f2465c32512ad6e7bfbfcdab2b0b4af8ef4))
* 523: actisense-serial can now read .ebl files ([9811d36](https://github.com/LOOKOUT-AI/canboat/commit/9811d369948123c5f761c83915b2e2fb14376ca1))
* 532 ([a9d043d](https://github.com/LOOKOUT-AI/canboat/commit/a9d043d3dc2883c2a31dcf4a9c1faf8ce6eabe43))
* 535 ([667bbb3](https://github.com/LOOKOUT-AI/canboat/commit/667bbb3e1f8ae98195e6f978e460d87ca474e2b9))
* 539 ([8fdf7c3](https://github.com/LOOKOUT-AI/canboat/commit/8fdf7c3ef161b0fe229fbc2521ab55829874f7ea))
* 550 ([0bc860e](https://github.com/LOOKOUT-AI/canboat/commit/0bc860eceed335b9dfc143421e4d8f3661dd279e))
* 553: INDUSTRY_CODE value 4 is 'Marine Industry' not 'Marine' ([a66c3c5](https://github.com/LOOKOUT-AI/canboat/commit/a66c3c59eb53c8e799574083a4523430b4bf8298))
* 554 ([ae40af8](https://github.com/LOOKOUT-AI/canboat/commit/ae40af82ecd0a8511c8d3449bfef0835e1497756))
* 560: MissingEnumeration NoCompanyFields should be MissingCompanyFields. ([c896fce](https://github.com/LOOKOUT-AI/canboat/commit/c896fcef466b363334edd951f7dfe0a410f4e79b))
* 562: Revert kWh -&gt; J change; kWh is the underlying resolution so a more precise translation of the data. ([c1d0239](https://github.com/LOOKOUT-AI/canboat/commit/c1d0239220b2b2a5bb5139f93434f08c9d9b50a9))
* 563 ([89026fa](https://github.com/LOOKOUT-AI/canboat/commit/89026fa88b88391ecba79b15bc33d68f71e9e7cd))
* 564 ([d59112b](https://github.com/LOOKOUT-AI/canboat/commit/d59112b03ddc4fcb7ad290c60d019a59ab077385))
* 564 ([81a7df4](https://github.com/LOOKOUT-AI/canboat/commit/81a7df41ceec2d5448387befce606136473730c8))
* 566: Manufacturer fields for proprietary PGNs should not have pk attribute set ([4368093](https://github.com/LOOKOUT-AI/canboat/commit/43680939abaa581a5d84cd4a16161dc2a683dace))
* 571: Maretron PGN 126720 field decoding improvements ([3856601](https://github.com/LOOKOUT-AI/canboat/commit/3856601168709347015e8fd693f6d093453d41cd))
* 575: fix Maretron lookup field lengths ([0f1e142](https://github.com/LOOKOUT-AI/canboat/commit/0f1e1424c2576bd94ea2551c11a91720824782e9))
* 590: remove analyzer/package.json ([091d288](https://github.com/LOOKOUT-AI/canboat/commit/091d288db60af32d0176b36df937be1d8c07c6ed))
* 592 ([b6f6c9f](https://github.com/LOOKOUT-AI/canboat/commit/b6f6c9f0511d384ea784a860d54dd5f210449301))
* add field resolutions and names for Maretron proprietary PGNs ([049c761](https://github.com/LOOKOUT-AI/canboat/commit/049c76150df1e37d861952493b841d79d3666590))
* **analyzer:** key JSON/text output on -camel mode, not camelName presence ([#746](https://github.com/LOOKOUT-AI/canboat/issues/746)) ([f890862](https://github.com/LOOKOUT-AI/canboat/commit/f8908620578172d9afb73cfc3f2cab8875e05b8b)), closes [#745](https://github.com/LOOKOUT-AI/canboat/issues/745)
* avoid signed left-shift overflow in fast-packet reassembly ([#650](https://github.com/LOOKOUT-AI/canboat/issues/650)) ([ef5b1c5](https://github.com/LOOKOUT-AI/canboat/commit/ef5b1c50685abe550a12df561dba8a55ab1c97cb))
* change SID fields from BINARY to UINT8 ([439c9e6](https://github.com/LOOKOUT-AI/canboat/commit/439c9e6fcb52d03cac9a69399ae2d1d91901ad3a))
* correct Maretron Windlass PGN assignments and add Carling PGNs ([83e47c0](https://github.com/LOOKOUT-AI/canboat/commit/83e47c0d53413ec184e5900a945ec16107dafc74))
* correct SIMNET Alert bits field length to 64 bits ([#657](https://github.com/LOOKOUT-AI/canboat/issues/657)) ([c104d8e](https://github.com/LOOKOUT-AI/canboat/commit/c104d8e7bb2d53d7bae3dc56f92aa91dfee0fb0a))
* decode STRING_LAU fields with 0xff encoding byte as empty ([#740](https://github.com/LOOKOUT-AI/canboat/issues/740)) ([97881b5](https://github.com/LOOKOUT-AI/canboat/commit/97881b53620d22913a66318aee854a1d4f41d892))
* define PGN 127751 as fast packet, flag as unconfirmed ([#655](https://github.com/LOOKOUT-AI/canboat/issues/655)) ([#669](https://github.com/LOOKOUT-AI/canboat/issues/669)) ([a178ddf](https://github.com/LOOKOUT-AI/canboat/commit/a178ddf8a95ffe2992dcc9616f1323f8d84780e2))
* don't fail a PGN when only a trailing reserved/spare field is short ([#663](https://github.com/LOOKOUT-AI/canboat/issues/663)) ([#664](https://github.com/LOOKOUT-AI/canboat/issues/664)) ([5788c7f](https://github.com/LOOKOUT-AI/canboat/commit/5788c7f571ebf383e61f9c369357a94fda410442))
* don't let fast-packet frame 0 complete against stale frames ([#738](https://github.com/LOOKOUT-AI/canboat/issues/738)) ([65d5599](https://github.com/LOOKOUT-AI/canboat/commit/65d55997e2b4eeb006ded2475456503afbf9baee))
* drop CAN 1.0 (11-bit) standard frames ([#647](https://github.com/LOOKOUT-AI/canboat/issues/647)) ([c9f5285](https://github.com/LOOKOUT-AI/canboat/commit/c9f5285f0618ff3722fbd5c26471449c946beff7)), closes [#400](https://github.com/LOOKOUT-AI/canboat/issues/400)
* drop the CANboat startup record from analyzer output under -fixtime ([#668](https://github.com/LOOKOUT-AI/canboat/issues/668)) ([27c3ef7](https://github.com/LOOKOUT-AI/canboat/commit/27c3ef706062b7c8d6f860a9c1c202c61da8b61b))
* give BEP Marine proprietary PGN stubs unique names ([2516b4d](https://github.com/LOOKOUT-AI/canboat/commit/2516b4d1bf2209df33c29cc2e6384833920412c6))
* give BEP Marine proprietary PGN stubs unique names ([b7b8ebf](https://github.com/LOOKOUT-AI/canboat/commit/b7b8ebf2f097c055ae521b82ca66022cc0970dc7))
* guard int64 conversion of field range maximum ([#651](https://github.com/LOOKOUT-AI/canboat/issues/651)) ([0c18ddc](https://github.com/LOOKOUT-AI/canboat/commit/0c18ddcdcd670c2fcf8f4ee6ca1f3bf31b784d18))
* honor explicit rangeMax in extractNumberNotEmpty ([d7774ba](https://github.com/LOOKOUT-AI/canboat/commit/d7774bac04276052edf5e6a5b2934f6f90fc9330))
* honor explicit rangeMax in extractNumberNotEmpty ([c7310ec](https://github.com/LOOKOUT-AI/canboat/commit/c7310ecea2e374dacda5256fad1a265853da915e)), closes [#600](https://github.com/LOOKOUT-AI/canboat/issues/600)
* **json:** export Signed for keyed (DYNAMIC_FIELD_VALUE) field types ([#691](https://github.com/LOOKOUT-AI/canboat/issues/691)) ([f705ea4](https://github.com/LOOKOUT-AI/canboat/commit/f705ea4d6c0d701ae61c7ab306cc2e8e57396451))
* n2k-displays branch ([a589c5a](https://github.com/LOOKOUT-AI/canboat/commit/a589c5a4ec7d44ed5ec7b0a2fc12fc0aee25c9b3))
* **navico:** correct 130822 Configuration Set naming and periodicity ([#734](https://github.com/LOOKOUT-AI/canboat/issues/734)) ([5a328c4](https://github.com/LOOKOUT-AI/canboat/commit/5a328c46a3f0146a3c75a75160791e5d73167cdd))
* **navico:** rename PGN 130846 to "Simnet: Key Value - Long" ([#705](https://github.com/LOOKOUT-AI/canboat/issues/705)) ([a2c9a43](https://github.com/LOOKOUT-AI/canboat/commit/a2c9a4370cc7b356f8d7a58642c177851cdee209))
* never write to a replayed file in actisense-serial ([#660](https://github.com/LOOKOUT-AI/canboat/issues/660)) ([#661](https://github.com/LOOKOUT-AI/canboat/issues/661)) ([2db94ad](https://github.com/LOOKOUT-AI/canboat/commit/2db94ade17f5b735209404bbd5d55c0e63218ef4))
* prevent out-of-bounds read for out-of-range PGNs ([#649](https://github.com/LOOKOUT-AI/canboat/issues/649)) ([a5a22b7](https://github.com/LOOKOUT-AI/canboat/commit/a5a22b74b9ac5688019cba62669df08562cebd6f)), closes [#644](https://github.com/LOOKOUT-AI/canboat/issues/644)
* resolve PACKET_RESOLUTION_UNKNOWN for multiple PGNs ([b77763e](https://github.com/LOOKOUT-AI/canboat/commit/b77763e5d5c56a84e37e0f2cb57cd94b475e6208))
* revert 130824 Annunciator field rename to match canboatjs tests ([bf5348c](https://github.com/LOOKOUT-AI/canboat/commit/bf5348cac693b1e382e50420c9caac14fccb7c7e))
* revert Maretron Annunciator 130824 to generic field names ([6471f78](https://github.com/LOOKOUT-AI/canboat/commit/6471f78545bdde02b63990a8eac0a0970e58843d))
* treat ESC as an escape byte only in .ebl files ([#431](https://github.com/LOOKOUT-AI/canboat/issues/431)) ([#659](https://github.com/LOOKOUT-AI/canboat/issues/659)) ([2bc71c2](https://github.com/LOOKOUT-AI/canboat/commit/2bc71c234140bc96ea5de458e2b54e093f382398))
* update stale external documentation URLs ([8e8004d](https://github.com/LOOKOUT-AI/canboat/commit/8e8004dc1b8daef060d8804492fea76549b587d8))
* update stale external documentation URLs ([0a343b6](https://github.com/LOOKOUT-AI/canboat/commit/0a343b617a1ec2df5cb1f65b084d46c78f1d2b94))
* update status flags for 24 standard PGNs confirmed by MConnect ([eb741bf](https://github.com/LOOKOUT-AI/canboat/commit/eb741bfc6348522bfcddcbd40dcd7fa98abf8406))
* use full RangeMax for PGN 60928 device instance fields ([ba9e0d6](https://github.com/LOOKOUT-AI/canboat/commit/ba9e0d65bb5713b3bc3bb6501d97a58096e3a3a8))


### Changed

* rename CAMEL macro to ID_AND_NAME ([#526](https://github.com/LOOKOUT-AI/canboat/issues/526)) ([#670](https://github.com/LOOKOUT-AI/canboat/issues/670)) ([a4fd69a](https://github.com/LOOKOUT-AI/canboat/commit/a4fd69a57e91a5f55c35485a4771d55824b0a450))
